...
I started with running `bruin init zoomcamp taxi-with-agent` to initialize the project.

## Context
- Project folder: @taxi-with-agent/pipeline
- Reference docs: @taxi-with-agent/README.md
